											...
											<div class="col-md-6">
												<div class="form-group">
													<label for="nameinput">품목명</label> <input type="text"
														...
														placeholder="품목명" value="${productDTO.pr_name }" />
												</div>
												<div class="form-group">
													<label for="partnerinput">협력사</label> <select
														class="form-select" id="partnerinput" name="pr_partner">
												...
												<div class="form-group">
													...
													<textarea class="form-control" id="typeinput" rows="5"
														placeholder="제작사양" name="pr_quality" required="required">
${productDTO.pr_quality }</textarea>
												...
												<div class="form-group">
													<label for="cateinput">카테고리</label> <select
														class="form-select" id="cateinput" name="pr_category">
												...
												<div class="form-group">
													<label for="statusinput">재고상태</label> <select
														class="form-select" id="statusinput" name="pr_status">
									...
									.on(
											...
											function(e) {
												...
												if (form != $("input[name='file']")) {
													form
															.append("<input type='file' name='file' value='${productDTO.pr_image }' style='display:none' />");
															...
															success : function(
																...
																if (result == "deleted") {
																	that
																			...
																			.remove();
																	alert("deleted");
																	let inputFile = "<input type='file' class='form-control-file' name='file' id='imginput' required='required' />";
																	$(
																			".imgUpload")
																			.append(
																					inputFile);
