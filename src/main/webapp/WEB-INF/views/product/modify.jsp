											...
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<textarea class="form-control" id="typeinput" rows="5"
														placeholder="제작사양" name="pr_quality" required="required">${productDTO.pr_quality }</textarea>
												</div>

												<div class="form-group">
													<label for="imginput">제품이미지</label> <input type="file"
														class="form-control-file" name="file" id="imginput"
														required="required" />
												</div>
