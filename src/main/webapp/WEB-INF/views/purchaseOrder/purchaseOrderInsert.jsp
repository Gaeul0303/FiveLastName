...
<BODY>
	...
	<button id = "ppr_id" value = ${po.ppr_id} onclick="insertPO(this)">발행하기</button>
	<button onClick="self.close();">새창 닫기</button>
	   
		<script>
		function insertPO(button) {
			
			  var ppr_id = button.getAttribute("value");

			  var form = document.createElement('form');
			  form.method = 'POST';
			  form.action = "/purchaseOrder/insert?ppr_id="+ppr_id;
