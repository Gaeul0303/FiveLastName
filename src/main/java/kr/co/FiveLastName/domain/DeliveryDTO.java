...
public class DeliveryDTO {
	...
	public DeliveryDTO(int in_id, int pr_id, String pr_name, String pr_size, String pr_type, String pr_quality,
			String pr_image, String pr_category, String id_code, int st_id, int in_safetyStock,
			int in_availableInventory, int in_physicalInventory, String in_status) {
		super();
		this.in_id = in_id;
		this.pr_id = pr_id;
